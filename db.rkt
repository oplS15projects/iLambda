...
(define (make-project instructions-url picture-url title fields)
  (list instructions-url  title fields))
...
;; Gummy Bear
(insert-project (make-project "http://weblab.cs.uml.edu/~kcarcia/OPLProject/gummy-bear.pdf"
...
(insert-project (make-project "http://weblab.cs.uml.edu/~kcarcia/OPLProject/measuring-heart-rate.pdf"
...
;; Heat Absorption
(insert-project (make-project "http://weblab.cs.uml.edu/~kcarcia/OPLProject/heat-absorption.pdf"
...
;; Holding Your Breath
(insert-project (make-project "http://weblab.cs.uml.edu/~kcarcia/OPLProject/holding-your-breath.pdf"
...
;; Freefall
(insert-project (make-project "http://weblab.cs.uml.edu/~kcarcia/OPLProject/freefall.pdf"
...
(insert-project (make-project "http://weblab.cs.uml.edu/~kcarcia/OPLProject/Correlation-of%20Bone-Length-and%20Height-Activity.pdf"
...
;; Density of Objects
(insert-project (make-project "http://isenseproject.org/media/06/06db85208e88aa120233d756b3550d5b/DensityofObjects.pdf"
...
(insert-project (make-project "http://isenseproject.org/media/f2/f208d643de0018c596313ad191165e21/Distribution%20of%20Dice%20Rolls.pdf"
...
(insert-project (make-project "http://isenseproject.org/media/48/480dd73dac5829aad56f98256449bd8f/Hooke's%20Law%20and%20Spring%20Constants.pdf"
...
(insert-project (make-project "http://isenseproject.org/media/3a/3a7e0f0d3f93543bb96d5200df7fdf93/Single_Draw_with_Replacement-Two_Distributions.pdf"
