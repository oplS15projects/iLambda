                ...
                (div ([class "container"])
                     (div ([class "main"])
                          ...
                          (form ([action,(embed/url create-project)] [class "form-horizontal"]) 
                                ...
                                (input ([type "number"] [class "form-control"] [name "id"] [value "4"] [style "visibility: hidden; height: 0px;"])))
                          ;; project - Freefall
                          (form ([action,(embed/url create-project)] [class "form-horizontal"]) 
                                (h4 "Freefall:  ")
                                (button ([type "submit"] [class "btn btn-success"]) "Create Project")
                          ...
                          (form ([action,(embed/url create-project)] [class "form-horizontal"]) 
                                (h4 "Correlation of Bone Length and Height Activity:  ")
                                (button ([type "submit"] [class "btn btn-success"]) "Create Project")
                          ...
                          ;; project - Hooke's Law
                          (form ([action,(embed/url create-project)] [class "form-horizontal"]) 
                                (h4 "Hooke's Law and Spring Constants:  ")
                                (button ([type "submit"] [class "btn btn-success"]) "Create Project")
                          ...
                          (form ([action,(embed/url create-project)] [class "form-horizontal"]) 
                                (h4 "Single Draw with Replacement Probability with Two Distributions:  ")
                                (button ([type "submit"] [class "btn btn-success"]) "Create Project")
